...
function handleGameOver() {
  setDinoLose();
  setTimeout(() => {
    document.addEventListener("keydown", startGame, { once: true }); /* impede clique acidental */
...
function handleRun(delta, speedScale) {
  ...
  if (currentFrameTime >= FRAME_TIME) {
    ...
    dino.src = `imgs/dino-run-${dinoFrame}.png`; /* troca entre as imagens pra simular movimento */
